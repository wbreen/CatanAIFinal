...
if exist "%JSETTLERS_HOME%\JSettlers.jar" goto checkJava
...
if not exist %SystemDrive%\JSettlers\JSettlers.jar goto checkCDrive
...
:runJSettlers
set MAIN_CLASS=soc.client.SOCPlayerClient
